...
- [x] **Phase 5: PII Masking Hardening and Test Coverage** - Close PII masking gaps for ssn/dob/passport columns, handle JSON parse failures, and add critical-path tests (completed 2026-03-27)
...
| 5. PII Masking Hardening and Test Coverage | 2/3 | Complete    | 2026-03-27 | - |
